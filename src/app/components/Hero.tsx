    ...
    <section className="py-28">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Image src="/Kelio-Photo-Profile.jpg" alt="Profile" width={100} height={100} className="rounded-full mb-4 w-32 h-32 object-cover ring-2 ring-primary" />
          </motion.div>
          <motion.h1 
          ...
          >
            Internal Auditor & Software Engineering Enthusiast | Building Web Solutions & Managing ISO 210001
          </motion.p>
          <motion.div 
